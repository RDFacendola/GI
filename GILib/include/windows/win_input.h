...
namespace gi_lib{
    ...
    namespace windows{
        ...
        public:
            ...
            virtual bool IsDown(ButtonCode button_code) const override;

            virtual bool IsPressed(ButtonCode button_code) const override;

            virtual bool IsReleased(ButtonCode button_code) const override;
        ...
        private:
            ...
            set<ButtonCode> down_buttons_;              ///< \brief Buttons being held down.

            set<ButtonCode> pressed_buttons_;           ///< \brief Buttons that were pressed during the last frame.

            set<ButtonCode> released_buttons_;          ///< \brief Buttons that were released during the last frame.
        ...
        public:
            ...
            virtual bool IsDown(KeyCode key_code) const override;

            virtual bool IsPressed(KeyCode key_code) const override;

            virtual bool IsReleased(KeyCode key_code) const override;
        ...
        private:
            ...
            set<KeyCode> down_keys_;            ///< \brief Keys being held down.

            set<KeyCode> pressed_keys_;         ///< \brief Keys that were pressed during the last frame.

            set<KeyCode> released_keys_;        ///< \brief Keys that were released during the last frame.
        ...
        inline bool Mouse::IsDown(ButtonCode button_code) const{

            return down_buttons_.find(button_code) != down_buttons_.end();
            
        }

        inline bool Mouse::IsPressed(ButtonCode button_code) const{

            return pressed_buttons_.find(button_code) != pressed_buttons_.end();

        }

        inline bool Mouse::IsReleased(ButtonCode button_code) const{
        ...
        inline bool Keyboard::IsDown(KeyCode button_code) const{

            return down_keys_.find(button_code) != down_keys_.end();

        }

        inline bool Keyboard::IsPressed(KeyCode button_code) const{

            return pressed_keys_.find(button_code) != pressed_keys_.end();

        }

        inline bool Keyboard::IsReleased(KeyCode button_code) const{
