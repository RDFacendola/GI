...
namespace gi_lib{
	...
	namespace dx11{
		...
		public:
			...
			/// \brief Push the pipeline state on the given device context.
			void Push(ID3D11DeviceContext& context);

			/// \brief Pop the pipeline state from the given device context.
			void Pop(ID3D11DeviceContext& context);
