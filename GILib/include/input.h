...
namespace gi_lib{
	...
	class IMouse{
		...
		virtual bool IsDown(unsigned short button_code) = 0;
		...
		virtual bool IsPressed(unsigned short button_code) = 0;
		...
		virtual bool IsReleased(unsigned short button_code) = 0;
		...
		virtual Vector2f GetMovement() = 0;
